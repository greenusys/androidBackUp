...
public class All_Quiz_adapter_Topic extends RecyclerView.Adapter<All_Quiz_adapter_Topic.MyViewHolder> {
    ...
    public All_Quiz_adapter_Topic(List<Topic_Category_Model> soldire_gd_models) {
