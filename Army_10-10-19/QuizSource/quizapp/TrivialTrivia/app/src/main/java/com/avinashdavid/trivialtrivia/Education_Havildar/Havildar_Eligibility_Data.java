...
public class Havildar_Eligibility_Data extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_havildar__eligibility__data);


        getSupportActionBar().setTitle("Education Havildar Eligibility");
        this.getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        final ProgressDialog pdLoading = new ProgressDialog(Havildar_Eligibility_Data.this);
        ...
        Request request = new Request.Builder()
                .url(URL.havildar_eligibility_data)
                .build();
        appController.getOkHttpClient().newCall(request).enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                ...
                Havildar_Eligibility_Data.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
