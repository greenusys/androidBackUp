...
public class Havildar_Tech_Exam_Pattern extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_havildar_tech_exam_pattern);

        getSupportActionBar().setTitle("Education Tradesman Exam Pattern");
        this.getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        final ProgressDialog pdLoading = new ProgressDialog(Havildar_Tech_Exam_Pattern.this);
        ...
        appController.getOkHttpClient().newCall(request).enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                ...
                Havildar_Tech_Exam_Pattern.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
