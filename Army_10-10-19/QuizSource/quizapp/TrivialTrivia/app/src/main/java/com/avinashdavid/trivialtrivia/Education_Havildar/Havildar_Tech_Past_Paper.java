...
public class Havildar_Tech_Past_Paper extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_havildar_past__paper);

        getSupportActionBar().setTitle("Education Havildar Past Papers");
        this.getSupportActionBar().setDisplayHomeAsUpEnabled(true);


        final ProgressDialog pdLoading = new ProgressDialog(Havildar_Tech_Past_Paper.this);
        ...
        appController.getOkHttpClient().newCall(request).enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                ...
                Havildar_Tech_Past_Paper.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
