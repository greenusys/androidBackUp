...
public class Havildar_Tech_syllabus_link extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_havildar_tech_syllabus_link);

        getSupportActionBar().setTitle("Education Havildar Syllabus Link");
        this.getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        final ProgressDialog pdLoading = new ProgressDialog(Havildar_Tech_syllabus_link.this);
        ...
        Request request = new Request.Builder()
                .url(URL.havildar_syllabus_link)
                .build();
        appController.getOkHttpClient().newCall(request).enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                ...
                Havildar_Tech_syllabus_link.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
