...
public class Clerk extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Soldier Clerk");
        ...
        sample_paper.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Clerk.this, Clerk_Sample_Paper.class);
                startActivity(i);
            }
        });
        ...
        past_paper.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Clerk.this, Clerk_Past_Paper.class);
                startActivity(i);
            }
        });
        eligibility.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Clerk.this, Clerk_Eligibility_Data.class);
                startActivity(i);
            }
        });
    ...
    private void open_link(final String value) {
        ...
        if(value.equals("syllabus"))
            request = new Request.Builder().url(URL.clerk_syll_link).get().build();

        if(value.equals("exam"))
            request = new Request.Builder().url(URL.clerk_exam_pattern).get().build();
        ...
        appController.getOkHttpClient().newCall(request).enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                ...
                Clerk.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
