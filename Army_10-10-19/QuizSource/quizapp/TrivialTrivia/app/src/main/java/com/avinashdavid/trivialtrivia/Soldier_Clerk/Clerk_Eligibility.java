...
public class Clerk_Eligibility extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_clerk_eligibility);

        getSupportActionBar().setTitle("Clerk Eligibility");
        ...
        qualification.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent intent=new Intent(Clerk_Eligibility.this,Clerk_Eligibility_Data.class);
