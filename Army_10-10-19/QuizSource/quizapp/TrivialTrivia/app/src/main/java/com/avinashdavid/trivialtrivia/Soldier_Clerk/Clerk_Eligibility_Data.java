...
public class Clerk_Eligibility_Data extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Soldier Clerk Eligibility");
        this.getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        final ProgressDialog pdLoading = new ProgressDialog(Clerk_Eligibility_Data.this);
        ...
        Request request = new Request.Builder()
                .url(URL.clerk_eligibility_data)
                .build();
        appController.getOkHttpClient().newCall(request).enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                ...
                Clerk_Eligibility_Data.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
