...
public class Soldier_GD extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_soldier__gd);
        ...
        getSupportActionBar().setTitle("Soldier GD");
        ...
        sample_paper.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Soldier_GD.this, Soldier_Sample_Paper.class);
                startActivity(i);
            }
        });
        ...
        past_paper.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Soldier_GD.this, Soldier_Past_Paper.class);
                startActivity(i);
            }
        });
        ...
        eligibility.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Soldier_GD.this, Soldier_Eligibility_Data.class);
                startActivity(i);
            }
        });
    ...
    private void open_link(final String value) {
        ...
        if(value.equals("syllabus"))
         request = new Request.Builder().url(URL.soldier_syllabus_link).get().build();

        if(value.equals("exam"))
         request = new Request.Builder().url(URL.soldier_exam_pattern).get().build();
        ...
        appController.getOkHttpClient().newCall(request).enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                ...
                Soldier_GD.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
