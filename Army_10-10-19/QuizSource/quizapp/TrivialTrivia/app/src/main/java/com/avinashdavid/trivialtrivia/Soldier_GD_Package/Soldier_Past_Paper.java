...
public class Soldier_Past_Paper extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_soldier_past__paper);

        getSupportActionBar().setTitle("Soldier GD Past Papers");
        this.getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        final ProgressDialog pdLoading = new ProgressDialog(Soldier_Past_Paper.this);
        ...
        appController.getOkHttpClient().newCall(request).enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                ...
                Soldier_Past_Paper.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
