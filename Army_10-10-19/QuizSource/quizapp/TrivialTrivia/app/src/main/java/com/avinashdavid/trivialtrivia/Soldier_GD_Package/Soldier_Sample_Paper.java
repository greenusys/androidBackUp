...
public class Soldier_Sample_Paper extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_soldier_sample__paper);


        getSupportActionBar().setTitle("Soldier GD Model Papers");
        this.getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        final ProgressDialog pdLoading = new ProgressDialog(Soldier_Sample_Paper.this);
        ...
        Request request = new Request.Builder().url(URL.soldier_sample_paper).build();
        appController.getOkHttpClient().newCall(request).enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                ...
                Soldier_Sample_Paper.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
