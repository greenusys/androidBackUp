...
import com.avinashdavid.trivialtrivia.Soldier_GD_Package.Soldier_syllabus_link;
...
/*import com.avinashdavid.trivialtrivia.Soldier_Clerk.Soldier_Nursing_Eligibility;*/
/*
import com.greenusys.army_project.AppController;
import com.greenusys.army_project.R;*/

public class Soldier_Nursing extends AppCompatActivity {


    LinearLayout sample_paper,past_paper,eligibility,syllabus,exam_pattern,syllabus_link,exam_link;
int flag=0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_soldier_nursing);

        getSupportActionBar().setTitle("Soldier Nursing");
        ...
        sample_paper.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Soldier_Nursing.this,Soldier_Nursing_Sample_Paper.class);
                startActivity(i );
            }
        });
        ...
        past_paper.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Soldier_Nursing.this,Soldier_Nursing_Past_Paper.class);
                startActivity(i );
            }
        });
        eligibility.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Soldier_Nursing.this,Nursing_Eligibility_Data.class);
                startActivity(i );
            }
        });
    ...
    private void open_link(final String value) {
        ...
        if(value.equals("syllabus"))
            request = new Request.Builder().url(URL.nursing_syllabus_link).get().build();

        if(value.equals("exam"))
            request = new Request.Builder().url(URL.nursing_exam_pattern).get().build();
        ...
        appController.getOkHttpClient().newCall(request).enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                ...
                Soldier_Nursing.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
