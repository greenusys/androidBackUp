...
public class Soldier_Nursing_Exam_Pattern extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_soldier_nursing_exam_pattern);

        getSupportActionBar().setTitle("Soldier Nursing Exam Pattern");
        this.getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        final ProgressDialog pdLoading = new ProgressDialog(Soldier_Nursing_Exam_Pattern.this);

        pdLoading.setMessage("Loading...");
        pdLoading.show();

        rv_gd = (RecyclerView) findViewById(R.id.rv_soldier_nursing_exam_pattarn);
        appController = (AppController) getApplicationContext();


        Request request = new Request.Builder()
                .url(URL.nursing_exam_pattern)
                .build();
        appController.getOkHttpClient().newCall(request).enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                ...
                Soldier_Nursing_Exam_Pattern.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
