...
public class Soldier_Nursing_Sample_Paper extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_soldier_nursing_sample__paper);

        getSupportActionBar().setTitle("Soldier Nursing Model Papers");
        this.getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        final ProgressDialog pdLoading = new ProgressDialog(Soldier_Nursing_Sample_Paper.this);

        pdLoading.setMessage("Loading...");
        pdLoading.show();

        rv_gd = (RecyclerView) findViewById(R.id.rv_soldier_nursing);
        appController = (AppController) getApplicationContext();


        Request request = new Request.Builder()
                .url(URL.nursing_sample_paper)
                .build();
        appController.getOkHttpClient().newCall(request).enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                ...
                Soldier_Nursing_Sample_Paper.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
