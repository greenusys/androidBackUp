...
public class Soldier_Tech extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_soldier_tech);

        getSupportActionBar().setTitle("Soldier Technical");
        ...
        sample_paper.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Soldier_Tech.this,Soldier_Tech_Sample_Paper.class);
                startActivity(i );
            }
        });
        ...
        past_paper.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Soldier_Tech.this,Soldier_Tech_Past_Paper.class);
                startActivity(i );
            }
        });
        eligibility.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Soldier_Tech.this,Tech_Eligibility_Data.class);
                startActivity(i );
            }
        });
    ...
    private void open_link(final String value) {
        ...
        if(value.equals("syllabus"))
            request = new Request.Builder().url(URL.Tech_syllabus_link).get().build();

        if(value.equals("exam"))
            request = new Request.Builder().url(URL.Tech_exam_pattern).get().build();
        ...
        appController.getOkHttpClient().newCall(request).enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                ...
                Soldier_Tech.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
