...
public class Soldier_Tech_Exam_Pattern extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_soldier_tech_exam_pattern);

        getSupportActionBar().setTitle("Soldier Technical Exam Pattern");
        this.getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        final ProgressDialog pdLoading = new ProgressDialog(Soldier_Tech_Exam_Pattern.this);
        ...
        appController.getOkHttpClient().newCall(request).enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                ...
                Soldier_Tech_Exam_Pattern.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
