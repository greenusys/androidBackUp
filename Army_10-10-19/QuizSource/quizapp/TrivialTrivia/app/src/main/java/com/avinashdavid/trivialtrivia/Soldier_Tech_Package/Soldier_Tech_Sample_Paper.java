...
public class Soldier_Tech_Sample_Paper extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tech_sample__paper);

        getSupportActionBar().setTitle("Soldier Technical Model Papers");
        this.getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        final ProgressDialog pdLoading = new ProgressDialog(Soldier_Tech_Sample_Paper.this);
        ...
        appController.getOkHttpClient().newCall(request).enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                ...
                Soldier_Tech_Sample_Paper.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
