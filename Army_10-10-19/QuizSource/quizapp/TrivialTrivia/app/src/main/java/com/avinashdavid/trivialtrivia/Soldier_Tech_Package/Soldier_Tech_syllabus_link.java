...
public class Soldier_Tech_syllabus_link extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_soldier_tech_syllabus_link);

        getSupportActionBar().setTitle("Soldier Technical Syllabus Link");
        this.getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        final ProgressDialog pdLoading = new ProgressDialog(Soldier_Tech_syllabus_link.this);
        ...
        appController.getOkHttpClient().newCall(request).enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                ...
                Soldier_Tech_syllabus_link.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
