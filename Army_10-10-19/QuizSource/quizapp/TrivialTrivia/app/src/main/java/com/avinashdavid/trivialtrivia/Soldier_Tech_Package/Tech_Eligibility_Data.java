...
public class Tech_Eligibility_Data extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Soldier Technical Eligibility");
        this.getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        final ProgressDialog pdLoading = new ProgressDialog(Tech_Eligibility_Data.this);
        ...
        appController.getOkHttpClient().newCall(request).enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                ...
                Tech_Eligibility_Data.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
