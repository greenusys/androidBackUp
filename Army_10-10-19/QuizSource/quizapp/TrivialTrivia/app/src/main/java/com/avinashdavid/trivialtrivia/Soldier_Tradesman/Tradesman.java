...
import com.avinashdavid.trivialtrivia.Soldier_GD_Package.Soldier_Exam_Pattern;
import com.avinashdavid.trivialtrivia.Soldier_GD_Package.Soldier_Past_Paper;
...
public class Tradesman extends AppCompatActivity {
    LinearLayout sample_paper,past_paper,eligibility,syllabus,exam_pattern;
    TextView syllabus_link,exam_link;
    int flag=0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tradesman);
      ...
      //  syllabus_link=(TextView)findViewById(R.id.syllabus_link);
       // exam_link=(TextView)findViewById(R.id.exam_pattern_link2);
        ...
        getSupportActionBar().setTitle("Tradesman");
        ...
        sample_paper.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Tradesman.this,Tradesman_Tech_Sample_Paper.class);
                startActivity(i );
            }
        });
        ...
        past_paper.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Tradesman.this,Tradesman_Tech_Past_Paper.class);
                startActivity(i );
            }
        });
        ...
        eligibility.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Tradesman.this,Tradesman_Eligibility_Data.class);
                startActivity(i );
            }
        });
    ...
    private void open_link(final String value) {
        ...
        if(value.equals("syllabus"))
            request = new Request.Builder().url(URL.tradesman_syllabus_link).get().build();

        if(value.equals("exam"))
            request = new Request.Builder().url(URL.tradesman_exam_pattern).get().build();
        ...
        appController.getOkHttpClient().newCall(request).enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                ...
                Tradesman.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
