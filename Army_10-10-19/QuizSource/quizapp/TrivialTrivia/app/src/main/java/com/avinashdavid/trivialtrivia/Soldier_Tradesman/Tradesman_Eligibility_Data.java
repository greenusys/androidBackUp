...
public class Tradesman_Eligibility_Data extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tradesman__eligibility__data);


        getSupportActionBar().setTitle("Soldier Tradesman Eligibility");
        this.getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        final ProgressDialog pdLoading = new ProgressDialog(Tradesman_Eligibility_Data.this);
        ...
        Request request = new Request.Builder()
                .url(URL.tradesman_eligibility_data)
                .build();
        appController.getOkHttpClient().newCall(request).enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                ...
                Tradesman_Eligibility_Data.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
