...
public class Tradesman_Tech_Past_Paper extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tradesman_past__paper);

        getSupportActionBar().setTitle("Soldier Tradesman Past Papers");
        this.getSupportActionBar().setDisplayHomeAsUpEnabled(true);


        final ProgressDialog pdLoading = new ProgressDialog(Tradesman_Tech_Past_Paper.this);

        pdLoading.setMessage("Loading...");
        pdLoading.show();
        rv_gd = (RecyclerView) findViewById(R.id.rv_soldier_tech_pastpaper);
        appController = (AppController) getApplicationContext();


        Request request = new Request.Builder()
                .url(URL.tradesman_past_paper)
                .build();
        appController.getOkHttpClient().newCall(request).enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                ...
                Tradesman_Tech_Past_Paper.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
