...
public class Tradesman_Tech_Sample_Paper extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tradesman_sample__paper);

        getSupportActionBar().setTitle("Soldier Tradesman Model Papers");
        this.getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        final ProgressDialog pdLoading = new ProgressDialog(Tradesman_Tech_Sample_Paper.this);
        ...
        rv_gd = (RecyclerView) findViewById(R.id.rv_soldier_tech);
        appController = (AppController) getApplicationContext();


        Request request = new Request.Builder()
                .url(URL.tradesman_sample_paper)
                .build();
        appController.getOkHttpClient().newCall(request).enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                ...
                Tradesman_Tech_Sample_Paper.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
