...
public class Tradesman_Tech_syllabus_link extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tradesman_tech_syllabus_link);

        getSupportActionBar().setTitle("Soldier Tradesman Syllabus Link");
        this.getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        final ProgressDialog pdLoading = new ProgressDialog(Tradesman_Tech_syllabus_link.this);

        pdLoading.setMessage("Loading...");
        pdLoading.show();

        rv_gd = (RecyclerView) findViewById(R.id.rv_soldier_tech_syllabuslink);
        appController = (AppController) getApplicationContext();


        Request request = new Request.Builder()
                .url(URL.tradesman_syllabus_link)
                .build();
        appController.getOkHttpClient().newCall(request).enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                ...
                Tradesman_Tech_syllabus_link.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
