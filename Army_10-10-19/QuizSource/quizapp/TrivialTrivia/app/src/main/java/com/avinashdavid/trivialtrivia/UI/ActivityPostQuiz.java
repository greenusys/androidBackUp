...
//        mRecyclerView.setDividerHeight(Float.valueOf(getResources().getDimension(R.dimen.activity_vertical_margin)).intValue());
        ...
        try {
            ...
            scoreView.setText("Marks Obtained "+Integer.toString(mQuizScorer.scoreQuiz(mQuestionScorers)));
...
//    }
    ...
    public void onBackPressed() {
        ...
        Intent intent=new Intent(ActivityPostQuiz.this, all_quiz_category.class);
