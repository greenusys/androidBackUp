...
public class ActivityWelcomePage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        System.out.println("idkaif"+getIntent().getStringExtra("id"));
        System.out.println("namekaif"+getIntent().getStringExtra("name"));
        System.out.println("datekaif"+getIntent().getStringExtra("date"));





        // System.out.print("Pathkaif"+ QuizDBContract.QuizEntry.CONTENT_URI);

        Log.e("kk","kak"+QuizDBContract.QuizEntry.CONTENT_URI);
    ...
    public void onBackPressed() {
        super.onBackPressed();
       Intent intent=new Intent(ActivityWelcomePage.this,Dashboard.class);
       startActivity(intent);
