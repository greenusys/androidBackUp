...
public class FragmentQuestionHoneycomb extends android.app.Fragment {
    ...
    private void setAndUpdateTextViews(){
        mQuestionView.setText(mCurrentDisplayQuestion.get(StartQuiz.INDEX_QUESTION));

        mChoice1TextView.setText("  "+mCurrentDisplayQuestion.get(StartQuiz.INDEX_CHOICE_1));
        mChoice2TextView.setText("  "+mCurrentDisplayQuestion.get(StartQuiz.INDEX_CHOICE_2));
        mChoice3TextView.setText("  "+mCurrentDisplayQuestion.get(StartQuiz.INDEX_CHOICE_3));
        mChoice4TextView.setText("  "+mCurrentDisplayQuestion.get(StartQuiz.INDEX_CHOICE_4));
    }
}
