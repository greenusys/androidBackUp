...
//            Log.d(LOG_TAG, "error while inserting category records: " + e);
    ...
    public void addQuestionScorer(int questionNumber, int category, int correctAnswer, int chosenAnswer){
      ...
      //  System.out.println("correct_answer"+String.valueOf(correctAnswer));
       // System.out.println("chosenAnswer_answer"+String.valueOf(chosenAnswer));
    ...
    public void addQuestionScorer(Boolean skip,int questionNumber, int category, int timeTaken, int correctAnswer, int chosenAnswer){
        QuestionScorer questionScorer = new QuestionScorer(skip,questionNumber, category, timeTaken, correctAnswer,chosenAnswer);
        mQuestionScorers.add(currentQuestionCount,questionScorer);
        currentQuestionCount++;
    }
