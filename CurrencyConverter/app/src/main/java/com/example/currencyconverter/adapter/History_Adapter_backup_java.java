...
public class History_Adapter_backup_java extends RecyclerView.Adapter<History_Adapter_backup_java.ViewHolder> {
    ...
    public History_Adapter_backup_java(Context context, ArrayList<History> friendRequestModels) {
