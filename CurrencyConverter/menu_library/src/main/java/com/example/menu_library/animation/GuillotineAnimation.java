package com.example.menu_library.animation;
...
import com.example.menu_library.util.ActionBarInterpolator;
import com.example.menu_library.util.GuillotineInterpolator;
...
public class GuillotineAnimation {
    ...
    private static final int DEFAULT_DURATION = 325;
