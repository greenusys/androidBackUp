...
public class ParentReg extends AppCompatActivity {
                        ...
                        if (names.length() == 0) {
                            ...
                            if(awesomeValidation.validate()) {
                                if (confirmPasswords.equals(passwords)) {
                                    ...
                                    Toast.makeText(ParentReg.this, "Password and Confirm password donot match", Toast.LENGTH_SHORT).show();
                                }
    ...
    private void bui() {
        AlertDialog.Builder builder1 = new AlertDialog.Builder(ParentReg.this);
        ...
        builder1.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int id) {
                dialog.cancel();
                Intent ins = new Intent(ParentReg.this, ParentLogin.class);
                startActivity(ins);
                finish();
            }
        });
            ...
            if (s != null) {
                try {
                    ...
                    if (CODE.equalsIgnoreCase("1")) {
                        ...
                        Toast.makeText(ParentReg.this, "" + jsonObject.getString("msg"), Toast.LENGTH_SHORT).show();
                    }
