...
public class Parent_Gallery extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_parent__gallery);
    ...
    public void API()
    {
        ...
        final ProgressDialog pdLoading = new ProgressDialog(Parent_Gallery.this);
        ...
        Request request = new Request.Builder().url("http://greenusys.website/mci/api/fetchGallery.php").build();
        appController.getClient().newCall(request).enqueue(new Callback() {
            @Override
            public void onFailure(Call call, IOException e) {
                System.out.println("Errorrrrr " + e.getMessage());

                Parent_Gallery.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
