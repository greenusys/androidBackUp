package com.example.digitalforgeco.ui;
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        if(server==null){
                            ...
                            System.out.println("serve_is_null");
                            transition(R.id.page_fail,TRANSITION_LENGTH);
                            ...
                            System.out.println("server_is_not_null");
    ...
    private void page_serverSelect(TestPoint selected, TestPoint[] servers){
        ...
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                System.out.println("kaif"+availableServers.get(spinner.getSelectedItemPosition()));
                b.setOnClickListener(null);
            }
        });
