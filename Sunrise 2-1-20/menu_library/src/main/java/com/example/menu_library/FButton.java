package com.example.menu_library;
...
public class FButton extends Button implements View.OnTouchListener {
    ...
    private LayerDrawable createDrawable(int radius, int topColor, int bottomColor) {
        ...
        if (isShadowEnabled && topColor != Color.TRANSPARENT) {
            //unpressed drawable
            layerDrawable.setLayerInset(0, 0, 0, 0, 0);  /*index, left, top, right, bottom_sheet*/
        } else {
            //pressed drawable
            layerDrawable.setLayerInset(0, 0, mShadowHeight, 0, 0);  /*index, left, top, right, bottom_sheet*/
        }
        layerDrawable.setLayerInset(1, 0, 0, 0, mShadowHeight);  /*index, left, top, right, bottom_sheet*/
