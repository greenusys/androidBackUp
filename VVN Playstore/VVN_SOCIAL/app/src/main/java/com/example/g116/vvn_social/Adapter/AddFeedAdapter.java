...
public class AddFeedAdapter extends RecyclerView.Adapter<AddFeedAdapter.MyViewHolder> {

    Context context;
    ArrayList<ModelFeed> modelFeedArrayList = new ArrayList<>();
    RequestManager glide;

    public AddFeedAdapter(Context context, ArrayList<ModelFeed> modelFeedArrayList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.home_page_post_item, parent, false);
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView tv_name, tv_time, tv_likes, tv_comments, tv_status, course_name;
