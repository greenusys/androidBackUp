...
public class MainActivity_ERP extends AppCompatActivity implements  GridView.OnItemClickListener {

    AsyncTask<Void, Void, Void> mRegisterTask;

    private static final int PLAY_SERVICES_RESOLUTION_REQUEST = 9000;
    private static final String TAG = "MainActivity_ERP";
        ...
        /*logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
              *//*  SharedPreferences myPrefs = getSharedPreferences("MY_PREF",
                ...
                Intent intent1 = new Intent(MainActivity_ERP.this, LoginActivitydasb.class);
                intent1.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(intent1); *//*

                AlertDialog.Builder alertDialog = new AlertDialog.Builder(MainActivity_ERP.this);
                ...
                alertDialog.setNegativeButton("NO", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Intent intent1 = new Intent(MainActivity_ERP.this, MainActivity_ERP.class);
                        startActivity(intent1);
                    }
                });
...
//                        .setAction("Action", null).show();
                Intent intent = new Intent(MainActivity_ERP.this, EnquiryActivity.class);
...
//                Snackbar.make(view, "Replace with your own action", Snackbar.LENGTH_LONG)
//                        .setAction("Action", null).show();
                Intent intent = new Intent(MainActivity_ERP.this, TopStudentActivity.class);
                startActivity(intent);
            }
        });
