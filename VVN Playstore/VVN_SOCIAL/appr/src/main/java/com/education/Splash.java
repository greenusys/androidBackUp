...
//        getSupportActionBar().hide();
    ...
    public  void go_next()
    {
        ...
        {
            System.out.println("kaif_loggin");
            Intent intent = new Intent(Splash.this, MainActivity_ERP.class);
            startActivity(intent);
            finish();
        }else{
            System.out.println("kaif_not_loggin");

            Intent intent = new Intent(Splash.this, LoginActivitydasb.class);
            startActivity(intent);
            finish();
        }
    }
