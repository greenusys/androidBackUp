...
public class Card extends Activity implements View.OnClickListener {
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(Card.this, DashboardRecharge.class));
        ...
        payMerchantDC.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (amt.equalsIgnoreCase("")) {
                    Toast.makeText(Card.this, "Please enter valid amount", Toast.LENGTH_LONG).show();
                }
                else if(amounts<=10)
                {
                    Toast.makeText(Card.this, "Amount must be greater than Rs 10", Toast.LENGTH_LONG).show();
                }
                else if (PaymentTypePos == 0) {
                    Toast.makeText(Card.this, "Please select valid Payment Mode", Toast.LENGTH_LONG).show();
                }
//				else if(cardTypePos==0)
//				{
//					Toast.makeText(Card.this, "Please select valid Card Type", Toast.LENGTH_LONG).show();
//				}				
                else {
                    Double doubleAmt = Double.valueOf(amt);
                    amt = doubleAmt.toString();
                    AMOUNT = ""+doubleAmt.intValue();
                    ...
                    Intent newPayIntent = new Intent(Card.this, PayActivity.class);
...
//					newPayIntent.putExtra("prodid", "Multi");
                    ...
                    //Optinal Parameters
                    newPayIntent.putExtra("customerName", "isama techonology"); //Only for Name
                    newPayIntent.putExtra("customerEmailID", "isamatechnolgy@gmail.com");//Only for Email ID
                    newPayIntent.putExtra("customerMobileNo", "7417966838");//Only for Mobile Number
...
//			decode= new sun.misc.BASE64Encoder().encode(encode.getBytes());
        ...
        if (requestCode == 1) {
            ...
            if (data != null) {
                ...
                if(message.equalsIgnoreCase("Transaction Successful!")){
                    ...
                    // Toast.makeText(Card.this, ""+doubleAmt.intValue(), Toast.LENGTH_SHORT).show();
                    ...
                    Log.e("data add money RESPONSE", "1.Status : "+data.getStringExtra("status") +"   2.ResponseKeyArray : "+data.getStringExtra("responseKeyArray")+"  3.ResponseValueArray : "+data.getStringExtra("responseValueArray"));
    ...
    public void sendNotification_To_User(String amount)
    {
        ...
        appController.getOkHttpClient().newCall(request).enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                ...
                Card.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        ...
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                if(statusss.equalsIgnoreCase("success")) {
                                    Toast.makeText(Card.this, "Suceess", Toast.LENGTH_SHORT).show();
                                    startActivity(new Intent(Card.this, PassbookRecharge.class));
                                    finish();
                                }
                                else{
                                    Toast.makeText(Card.this, "Failure"+message, Toast.LENGTH_SHORT).show();
                                    startActivity(new Intent(Card.this, PassbookRecharge.class));
                                    finish();
                                }
                            }
    ...
    protected void onRestart() {
        super.onRestart();
        startActivity(new Intent(Card.this, MainActivity.class));
    }
}
