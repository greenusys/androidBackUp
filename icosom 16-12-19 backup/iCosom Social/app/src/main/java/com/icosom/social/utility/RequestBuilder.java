...
public class RequestBuilder {
    ...
    public static RequestBody noParameterTest(){
        return new FormBody.Builder()
                .build();
    }
    ...
    public static RequestBody oneParameter(String key_a, String value_a){
        return new FormBody.Builder()
                .add(key_a,value_a)
                .build();
    }
    ...
    public static RequestBody sevenParams(String token_key,String token_value,String key_a, String value_a, String key_b, String value_b, String key_c, String value_c, String key_d, String value_d, String key_e, String value_e, String key_f, String value_f ){
        return new FormBody.Builder()
    ...
    public static RequestBody twoParemeter(String key_a, String value_a ){
        return new FormBody.Builder()
                .add(key_a,value_a)
                .build();
    }
    ...
    public static RequestBody fourParameter(String key_a, String value_a,String key_b, String value_b ){
        return new FormBody.Builder()
                .add(key_a,value_a)
                .add(key_b,value_b)
                .build();
    ...
    public static RequestBody voucher_six_params(String key_a, String value_a,String key_b, String value_b,String key_c, String value_c ){
        return new FormBody.Builder()
                .add(key_a,value_a)
                .add(key_b,value_b)
                .add(key_c,value_c)
    ...
    public static RequestBody kycParameter(String key_a, String value_a, String key_b, String value_b, String key_c, String value_c, String key_d, String value_d, String key_e, String value_e, String key_f, String value_f, String key_g, String value_g, String key_h, String value_h,String key_i, String value_i, String key_j, String value_j,String key_k, String value_k, String key_l, String value_l,String key_m, String value_m, String key_n, String value_n ){
        return new FormBody.Builder()
                .add(key_a,value_a)
                .add(key_b,value_b)
                .add(key_c, value_c)
