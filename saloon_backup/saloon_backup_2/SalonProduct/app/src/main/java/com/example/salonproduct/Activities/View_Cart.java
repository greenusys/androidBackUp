...
public class View_Cart extends AppCompatActivity implements View_Cart_View {
    ...
    public void setPayment_Detail() {
        ...
        total_cart_items.setText(cart_models.size()+" Item in Your Bag");
            ...
            total_cart_items.setText("No Item in Your Bag");
    ...
    if(cart_models.size()==0)
    startActivity(new Intent(getApplicationContext(),HomeActivity.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP));
else {
